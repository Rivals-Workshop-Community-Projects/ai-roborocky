...
#define punch__hitbox_update // Version 0
    with (pHitBox){
    	if (player == other.player){
    		if (attack == PUNCH_ATTACK){
    			if (hbox_num == 1){
...
#macro PUNCH_ATTACK AT_NSPECIAL

#define star__hitbox_update // Version 0
    if (attack == STAR_ATTACK and hbox_num == STAR_HITBOX_NUM){
...
#macro STAR_ATTACK AT_DSPECIAL

#macro STAR_HITBOX_NUM 2
